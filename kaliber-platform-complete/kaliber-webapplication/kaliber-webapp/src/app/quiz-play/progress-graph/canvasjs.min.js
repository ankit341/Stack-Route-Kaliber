...
/*jshint ignore:start*/
(function() {
  function qa(h, p) { h.prototype = eb(p.prototype);
    h.prototype.constructor = h;
    h.base = p.prototype }

  function eb(h) {
    function p() {} p.prototype = h; return new p }
  ...
  function $(h, p) { var D = !1;
    0 > h && (D = !0, h *= -1);
    h = "" + h; for (p = p ? p : 1; h.length < p;) h = "0" + h; return D ? "-" + h : h }

  function Ia(h) { if (!h) return h;
    h = h.replace(/^\s\s*/, ""); for (var p = /\s/, D = h.length; p.test(h.charAt(--D));); return h.slice(0, D + 1) }
  ...
  function N(h) { var p = ((h & 16711680) >> 16).toString(16),
      D = ((h & 65280) >> 8).toString(16);
    h = ((h & 255) >> 0).toString(16);
    p = 2 > p.length ? "0" + p : p;
    D = 2 > D.length ? "0" + D : D;
    h = 2 > h.length ? "0" + h : h; return "#" + p + D + h }

  function fb(h, p) { var D = this.length >>> 0,
      r = Number(p) || 0,
      r = 0 > r ? Math.ceil(r) : Math.floor(r); for (0 > r && (r += D); r < D; r++)
      if (r in this && this[r] === h) return r; return -1 }
    ...
    if (isNaN(u)) {
      try {
        ...
        if (!xa) { var H = document.body;
          ...
          xa.appendChild(F);
          H.appendChild(xa) } xa.style.display = "";
        xa.setAttribute("style", h);
        u = Math.round(xa.offsetHeight);
        xa.style.display = "none"
      } catch (z) { u = Math.ceil(1.1 * p) } u = Math.max(u, p);
      $a[r] = u
    }
    return u
  }
  ...
  function O(h, p, D, r, u) {
    ...
    return h.addEventListener ? (h.addEventListener(p, D, u), D) : h.attachEvent ?
      (r = function(p) { p = p || window.event;
        ...
        D.call(h, p) }, h.attachEvent("on" + p, r), r) : !1
  }

  function ab(h, p, D) { h *= W;
    p *= W;
    h = D.getImageData(h, p, 2, 2).data;
    p = !0; for (D = 0; 4 > D; D++)
      if (h[D] !== h[D + 4] | h[D] !== h[D + 8] | h[D] !== h[D + 12]) { p = !1; break } return p ? h[0] << 16 | h[1] << 8 | h[2] : 0 }
  ...
  function Ga(h, p, r, u, v) { "undefined" === typeof v && (v = 0);
    this._padding = v;
    this._x1 = h;
    this._y1 = p;
    this._x2 = r;
  ...
  function ka(h, p) { ka.base.constructor.call(this, "TextBlock", null, p, null, null);
    this.ctx = h;
    this._isDirty = !0;
  ...
  (function() {
    ...
    U._fTWm = function(h) { if ("undefined" === typeof U.pro.sCH && !db) try { var p = h[U.fSDec(U.obj.cntx)];
        p[U.fSDec(U.obj.txtBl)] = U.fSDec(U.obj.tp);
        p[U.fSDec(U.obj.fnt)] = 11 + U.fSDec(U.obj.fntStr);
        p[U.fSDec(U.obj.fSy)] = U.fSDec(U.obj.grClr);
        p[U.fSDec(U.obj.fTx)](U.fSDec(U.obj.trVs), 2, h.height - 11 - 2) } catch (r) {} }
  })();
  var $a = {},
    xa = null,
    kb =
    ...
    ba = function(h, p, r) {
      ...
      for (var Q = 0; z && Q < z.length; Q++)
        if (p = z[Q], "." === p && 0 > E) E = Q;
          ...
          0 > E ? (L.push(p), "#" === p || "0" === p ? I++ : "," === p && S++) : (R.push(p), "#" !== p && "0" !== p || N++) } O && (p = Math.floor(h),
  ...
  V.prototype.get = function(h) { var p = ra[this._defaultsKey]; if ("options" === h) return this.options && this.options._isPlaceholder ? null : this.options; if (p.hasOwnProperty(h) || p.publicProperties && p.publicProperties.hasOwnProperty(h)) return this[h];
  ...
  ka.prototype.setText = function(h) { this.text = h;
    this._isDirty = !0;
    this._wrappedText = null };
  ...
  ka.prototype._getLineWithWidth = function(h, p, r) {
    ...
    for (this.ctx.font = this._getFontString(); u <= v;) { var H = Math.floor((u + v) / 2),
      ...
      else break } r > p && 1 < F.length && (F = F.substr(0, F.length - 1), r = this.ctx.measureText(F).width);
    p = !0;
  ...
  ka.prototype._getFontString = function() { var h;
    h = "" + (this.fontStyle ? this.fontStyle + " " : "");
    h += this.fontWeight ? this.fontWeight + " " : "";
    h += this.fontSize ? this.fontSize + "px " : ""; var p = this.fontFamily ? this.fontFamily + "" : "";!r && p && (p = p.split(",")[0], "'" !== p[0] && '"' !== p[0] && (p = "'" + p + "'")); return h += p };
  qa(Va, V);
  qa(Aa, V);
  ...
  Wa.prototype.get = function(h, p) { var r = null;
    0 < this.pool.length ? (r = this.pool.pop(), Oa(r, h, p)) : r = ta(h, p); return r };
  ...
  Na.Chart = function() {
    ...
    p.prototype.destroy = function() {
      ...
      for (var d = 0; d < a.length; d++) { var b = a[d][0],
          ...
          g = a[d][3],
          g = g || !1;
        b.removeEventListener ? b.removeEventListener(c, e, g) : b.detachEvent && b.detachEvent("on" + c, e) } this.allDOMEventHandlers = [];
    ...
    p.prototype._updateOptions = function() {
      ...
      if (!this._dropdownMenu && this.exportEnabled && r) {
        ...
        O(b, "mouseover", function() { d || (this.style.backgroundColor = a.toolbar.backgroundColorOnHover, this.style.color = a.toolbar.fontColorOnHover) }, this.allDOMEventHandlers,
          !0);
    ...
    p.prototype._updateSize = function() {
      ...
      if (this.canvas.width !== d * W || this.canvas.height !==
        b * W) { for (var c = 0; c < a.length; c++) Oa(a[c], d, b);
        a = !0 } else a = !1;
      return a
    };
    ...
    p.prototype.setLayout = function() {
      ...
      if (0 < this._axes.length && (this.zoomEnabled || this.panEnabled))
        for (d = 0; d < this._axes.length; d++)
          if (null !== this._axes[d].viewportMinimum || null !== this._axes[d].viewportMaximum) { b = !0; break } b ? (Qa(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness + "px solid " +
      ...
      for (d = 0; d < this._axes.length; d++)
        if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) { r ? (this._breaksCanvas = ta(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx); break } this._preRenderCanvas = ta(this.width, this.height);
    ...
    p.prototype.renderElements = function() {
      ...
      if (this.animatedRender) { var c = ta(this.width, this.height);
        c.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } /*hb(this)*/;
      ...
      if (0 < b.length) s.disableToolTip = !0, s._animator.animate(200, s.animationDuration, function(a) {
        ...
        s.dispatchEvent("dataAnimationIterationEnd", { chart: s }) } this.attachPlotAreaEventHandlers();
      ...
      this.renderCount++;
      Ja && (s = this, setTimeout(function() { var a = document.getElementById("ghostCanvasCopy");
        a && (Oa(a, s.width, s.height), a.getContext("2d").drawImage(s._eventManager.ghostCanvas, 0, 0)) }, 2E3));
      ...
      for (var a = "", d = 0; d < this.data.length; d++)
        if (a =
          ...
          for (var b = null, c = !1, e = null, g = !1, k = 0; k < this.plotInfo.plotTypes.length; k++)
            if (this.plotInfo.plotTypes[k].type === a.type) { c = !0;
              b = this.plotInfo.plotTypes[k]; break } c || (b = { type: a.type, totalDataSeries: 0, plotUnits: [] }, this.plotInfo.plotTypes.push(b));
          for (k = 0; k < b.plotUnits.length; k++)
            if (b.plotUnits[k].axisYType === a.axisYType && b.plotUnits[k].axisXType === a.axisXType && b.plotUnits[k].axisYIndex === a.axisYIndex &&
              b.plotUnits[k].axisXIndex === a.axisXIndex) { g = !0;
              e = b.plotUnits[k]; break } g || (e = {
            type: a.type,
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          for (w = 0; w < l.dataPoints.length; w++) {
            ...
            if (0 < w) {
              if (a.axisX.logarithmic) { var B = c / l.dataPoints[w - 1].x;
                1 > B && (B = 1 / B);
                b.minDiff > B && 1 !== B && (b.minDiff = B) } else B = c - l.dataPoints[w - 1].x, 0 > B &&
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = !1, l = !1, w = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          for (q = 0; q < s.dataPoints.length; q++) {
            ...
            c > b.max && (b.max = c);
            if (0 < q) {
              if (a.axisX.logarithmic) { var t = c / s.dataPoints[q - 1].x;
                1 > t && (t = 1 / t);
                b.minDiff > t && 1 !== t && (b.minDiff = t) } else t = c - s.dataPoints[q - 1].x, 0 > t && (t *= -1), b.minDiff > t && 0 !== t && (b.minDiff = t);
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, k, l = !1, w = 0; w < a.dataSeriesIndexes.length; w++) {
          ...
          for (s = 0; s < m.dataPoints.length; s++) {
            ...
            if ((e = m.dataPoints[s].y) && e.length) { g = Math.min.apply(null, e);
              k = Math.max.apply(null, e);
              B = !0; for (var p = 0; p < e.length; p++) null === e.k && (B = !1);
              B && (q || (h = f), f = c) } c < b.min && (b.min = c);
            c > b.max &&
              (b.max = c);
            g < d.min && (d.min = g);
            k > d.max && (d.max = k);
            ...
            if (!(c < r) || q) {
              ...
              if (b.viewPortMin === c && e)
                for (p = 0; p < e.length; p++)
                  if (null === e[p] && f < c) { b.viewPortMin = f; break } null === e ? b.viewPortMin === c && f < c && (b.viewPortMin = f) : (g < d.viewPortMin && (d.viewPortMin = g), k > d.viewPortMax && (d.viewPortMax = k))
            }
          }
            ...
            if (this._axes[k].dataInfo.dataPointYPositiveSums) {
              ...
              for (l in n)
                if (n.hasOwnProperty(l) && !isNaN(l) && (q = n[l], !u(q))) { var f = Math.floor((q - w) / c);
                  q < s[f].min && (s[f].min = q);
                  q > s[f].max && (s[f].max = q) } delete this._axes[k].dataInfo.dataPointYPositiveSums
            }
            if (this._axes[k].dataInfo.dataPointYNegativeSums) { n = this._axes[k].dataInfo.dataPointYNegativeSums;
              s = m; for (l in n) n.hasOwnProperty(l) && !isNaN(l) && (q = -1 * n[l], u(q) || (f = Math.floor((q - w) / c), q < s[f].min && (s[f].min = q), q > s[f].max && (s[f].max = q)));
              delete this._axes[k].dataInfo.dataPointYNegativeSums }
            for (l = 0; l < m.length -
              1; l++)
              if (s = m[l].max, isFinite(s))
                for (; l < m.length - 1;)
                  if (w = m[l + 1].min, isFinite(w)) { q = w - s;
    ...
    p.prototype.getDataPointAtXY = function(a, d, b) {
      ...
      for (var c = [], e = this._dataInRenderedOrder.length - 1; 0 <= e; e--) { var g = null;
        (g = this._dataInRenderedOrder[e].getDataPointAtXY(a, d, b)) && c.push(g) } a = null;
      d = !1;
      for (b = 0; b < c.length; b++)
        if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type)
          if (e = na("markerSize", c[b].dataPoint, c[b].dataSeries) || 8, c[b].distance <= e / 2) { d = !0; break } for (b = 0; b < c.length; b++) d && "line" !== c[b].dataSeries.type && "stepLine" !== c[b].dataSeries.type && "area" !== c[b].dataSeries.type &&
        "stepArea" !== c[b].dataSeries.type || (a ? c[b].distance <= a.distance && (a = c[b]) : a = c[b]);
      return a
    };
    p.prototype.getObjectAtXY = function(a, d, b) { var c = null; if (b = this.getDataPointAtXY(a, d, b || !1)) c = b.dataSeries.dataPointIds[b.dataPointIndex];
      else if (r) c = ab(a, d, this._eventManager.ghostCtx);
      else
        for (b = 0; b < this.legend.items.length; b++) { var e = this.legend.items[b];
    ...
    p.prototype._touchEventHandler = function(a) {
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(b && 1 < b.length)) {
          e = Ra(c);
          e.time = new Date;
          try { var k = e.y - this._lastTouchData.y,
              g = e.time - this._lastTouchData.time; if (1 < Math.abs(k) && this._lastTouchData.scroll || 5 < Math.abs(k) && 250 > g) this._lastTouchData.scroll = !0 } catch (l) {} this._lastTouchEventType = a.type;
    ...
    p.prototype._plotAreaMouseUp = function(a, d) {
      if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
        ...
        if (this.panEnabled || this.zoomEnabled) {
          ...
          else if ((!e || 2 < Math.abs(c)) && (!g || 2 < Math.abs(b)) && this.zoomEnabled) { if (!this.dragStartPoint) return;
            b = e ? this.dragStartPoint.x : this.plotArea.x1;
            c = g ? this.dragStartPoint.y : this.plotArea.y1;
            e = e ? a : this.plotArea.x2;
            g = g ? d : this.plotArea.y2;
            2 < Math.abs(b - e) && 2 < Math.abs(c - g) && this._zoomPanToSelectedRegion(b, c, e, g) && (k = !0) } k &&
    ...
    p.prototype.renderLine = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], k, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var s = m.dataPoints,
            q = "solid";
          if (b.setLineDash) { var n = R(m.nullDataLineDashType, m.lineThickness),
              q = m.lineDashType,
    ...
    p.prototype.renderSpline = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var k = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var s = m.dataPoints,
            q = "solid";
          if (c.setLineDash) { var n = R(m.nullDataLineDashType, m.lineThickness),
              q = m.lineDashType,
              f = R(q, m.lineThickness);
            c.setLineDash(f) }
          var B = m.id;
            ...
            for (u = !1, p = 0; p < s.length; p++)
              if (t = s[p].getTime ? s[p].x.getTime() : s[p].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !u)))
                if ("number" !== typeof s[p].y) 0 < p && !u && (m.connectNullData ? c.setLineDash && (0 < x.length && (m.options.nullDataLineDashType || !s[p - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = n, q = m.nullDataLineDashType) : (d(x), x = [])), u = !0;
                  ...
                  if (0 < s[p].markerSize || 0 < m.markerSize) { var y = m.getMarkerProperties(p, t, u, c);
                    k.push(y);
                    ma = N(ma);
                    r && k.push({ x: t, y: u, ctx: e, type: y.type, size: y.size, color: ma, borderColor: ma, borderThickness: y.borderThickness }) }(s[p].indexLabel || m.indexLabel || s[p].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: s[p], dataSeries: m, point: { x: t, y: u }, direction: 0 > s[p].y === a.axisY.reversed ? 1 : -1, color: B });
                  u = !1
                } d(x)
        }
        ia.drawMarkers(k);
          ...
          if (0 < t.length) {
            ...
            for (m = 0; m < t.length; m++)
              if (c = t[m].x.getTime ? t[m].x.getTime() : t[m].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y) {
                ...
                else if (q = a.axisY.convertValueToPixel(t[m].y), 0 <= t[m].y) { var A = "undefined" !== typeof g[c] ? g[c] : 0;
                  q -= A;
                  y = n - A;
                  g[c] = A + (y - q) } else A = k[c] ? k[c] : 0, y = q + A, q = n + A, k[c] = A + (y - q);
          ...
          if (0 < t.length)
            for (var u = 5 < f && h.bevelEnabled ? !0 : !1, m = 0; m < t.length; m++)
              if (c = t[m].x.getTime ? t[m].x.getTime() : t[m].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y) {
                ...
                else if (q = a.axisY.convertValueToPixel(q), 0 <= t[m].y) { var A = "undefined" !== typeof g[c] ? g[c] : 0;
                  q -= A;
                  y = n - A;
                  a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.y1 - q) && (q = e.y1);
                  g[c] = A + (y - q) } else A = "undefined" !== typeof k[c] ?
          ...
          if (0 < t.length) {
            ...
            for (m = 0; m < t.length; m++)
              if (c = t[m].x.getTime ? t[m].x.getTime() :
                ...
                else if (s = a.axisY.convertValueToPixel(t[m].y), 0 <= t[m].y) { var A = g[c] ? g[c] : 0;
                  y = n + A;
                  s += A;
                  g[c] = A + (s - y) } else A = k[c] ? k[c] : 0, y = s - A, s = n - A, k[c] = A + (s - y);
                c = t[m].color ? t[m].color : h._colorSet[m % h._colorSet.length];
            ...
            for (m = 0; m < t.length; m++)
              if (c = t[m].x.getTime ? t[m].x.getTime() : t[m].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                ...
                var v = q - a.plotType.plotUnits.length * f / 2 + a.index * f << 0,
                  y = v + f << 0;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y) { l[c] = x + (l[c] ? l[c] : 0); if (0 >= l[c]) continue;
                  x = g[c] ? g[c] : n;
                  g[c] = s = a.axisY.convertValueToPixel(l[c]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[m].y) w[c] = x + (w[c] ? w[c] : 0), s = k[c] ? k[c] :
                  n, k[c] = x = a.axisY.convertValueToPixel(w[c]);
                else if (s = a.axisY.convertValueToPixel(x), 0 <= t[m].y) { var A = g[c] ? g[c] : 0;
                  x = n + A;
                  s += A;
                  a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.x2 - s) && (s = e.x2);
                  g[c] = A + (s - x) } else A = k[c] ? k[c] : 0, x = s - A, s = n - A, a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.x1 - x) && (x = e.x1), k[c] = A + (s - x);
                c = t[m].color ? t[m].color : p._colorSet[m % p._colorSet.length];
            ...
            for (h = !1; f < n.length; f++)
              if (B = n[f].x.getTime ? n[f].x.getTime() : n[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !h)))
                if ("number" !== typeof n[f].y) 0 < f && !h && (q.connectNullData ? c.setLineDash && (0 < x.length && (q.options.nullDataLineDashType ||
                  ...
                  if (0 !== n[f].markerSize && (0 < n[f].markerSize || 0 < q.markerSize)) { var ca = q.getMarkerProperties(f, B, h, c);
                    l.push(ca);
                    Y = N(Y);
                    r && l.push({ x: B, y: h, ctx: e, type: ca.type, size: ca.size, color: Y, borderColor: Y, borderThickness: ca.borderThickness }) }(n[f].indexLabel || q.indexLabel || n[f].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
    ...
    p.prototype.renderStackedArea = function(a) {
      function d() {
        if (!(1 > m.length)) {
          for (0 < A.lineThickness && c.stroke(); 0 < m.length;) { var a = m.pop();
            c.lineTo(a.x, a.y);
            r && u.lineTo(a.x, a.y) } c.closePath();
              ...
              if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da)))
                if ("number" !== typeof Z.y) A.connectNullData || (da || C) || d(), da = !0;
                  ...
                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { q[g] = Z.y + (q[g] ? q[g] : 0); if (0 >= q[g] && a.axisY.logarithmic) continue;
                    h = a.axisY.convertValueToPixel(q[g]) } else h = a.axisY.convertValueToPixel(Z.y), h -= oa;
                  m.push({ x: f, y: p - oa });
                  w[g] = p - h;
                  ...
                  if (0 <= A.dataPointIndexes[g]) { var la = A.dataPointIds[A.dataPointIndexes[g]];
                    this._eventManager.objectMap[la] = { id: la, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: A.dataPointIndexes[g], x1: f, y1: h } } 0 <= A.dataPointIndexes[g] && 0 !== Z.markerSize && (0 < Z.markerSize || 0 < A.markerSize) && (oa = A.getMarkerProperties(A.dataPointIndexes[g], f, h, c), k.push(oa), g = N(la), r && k.push({ x: f, y: h, ctx: u, type: oa.type, size: oa.size, color: g, borderColor: g, borderThickness: oa.borderThickness }));
              ...
              if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData ||
                ...
                if ("number" !== typeof Z.y) A.connectNullData || (da || u) || d(), da = !0;
                  ...
                  if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { q[g] = oa + (q[g] ? q[g] : 0); if (0 >= q[g] && a.axisY.logarithmic) continue;
                    h = a.axisY.convertValueToPixel(q[g]) } else h = a.axisY.convertValueToPixel(oa), h -= la;
                  m.push({ x: f, y: C - la });
                  w[g] = C - h;
                  ...
                  if (0 <= A.dataPointIndexes[g]) { var G = A.dataPointIds[A.dataPointIndexes[g]];
                    this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: A.dataPointIndexes[g], x1: f, y1: h } } 0 <= A.dataPointIndexes[g] && 0 !== Z.markerSize && (0 < Z.markerSize || 0 < A.markerSize) && (la =
        ...
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < v.length)
            for (var x = 5 < n && u.bevelEnabled ? !0 : !1, z = !1, y = null, A = null, k = 0; k < v.length; k++)
              if (v[k].getTime ? s = v[k].x.getTime() : s = v[k].x, "number" !== typeof v[k].y) { if (0 < k && !z && u.connectNullData) var D = u.options.nullDataLineDashType || !v[k - 1].lineDashType ? u.nullDataLineDashType : v[k - 1].lineDashType;
                z = !0 } else {
    ...
    var ja = function(a, d, b, c, e, g, k, l, h) {
      if (!(0 > b)) {
        ...
        if (!r) { var m = Number((k % (2 * Math.PI)).toFixed(8));
          Number((g % (2 * Math.PI)).toFixed(8)) === m && (k -= 1E-4) } a.save();
        a.globalAlpha = l;
          ...
          for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < s.length; d++) {
            ...
            if (k.midAngle > Math.PI / 2 - t && k.midAngle < Math.PI / 2 + t) {
              if (0 === a || f[c].midAngle >
                k.midAngle) c = d;
              a++
            } else if (k.midAngle > 3 * Math.PI / 2 - t && k.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || f[e].midAngle > k.midAngle) e = d;
              b++ } k.hemisphere = g > Math.PI / 2 && g <= 3 * Math.PI / 2 ? "left" : "right";
      ...
      function l() {
        ...
        if (h.subtitles)
          for (var a = 0; a < h.subtitles.length; a++) { var b = h.subtitles[a];
            (b.dockInsidePlotArea || "center" === b.horizontalAlign && "center" === b.verticalAlign) && b.render() } h.legend && (h.legend.dockInsidePlotArea || "center" === h.legend.horizontalAlign && "center" === h.legend.verticalAlign) && (h.legend.setLayout(), h.legend.render())
      }
      var h = this;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var m =
    ...
    p.prototype.renderFunnel = function(a) {
      ...
      function e() {
        ...
        d = !1;
        c = 0;
        for (var g, l = L - V - S / 2, l = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth > l ? l : t.indexLabelMaxWidth : l, k = J.length - 1; 0 <= k; k--) { g = C[J[k].id];
          c = J[k];
          e = c.textBlock;
      ...
      function h(a, b, c) {
        ...
        if (0 === W.length) k =
          ia;
        else { e = D * (1 != W.length || 0 != W[0] && W[0] != P.length - 1 ? 2 : 1) / m(); for (var q = 0; q < P.length; q++) { if (1 == W.length && 0 == W[0]) { if (0 === q) { k.push(ia[q]);
                d = l; continue } } else 0 === q && (d = -1 * l);
            k.push(ia[q] + d); if (0 <= W.indexOf(q) || q < P.length && 0 <= W.indexOf(q + 1)) d += e } } f = function() { for (var a = [], b = 0; b < P.length; b++) a.push(k[b] - P[b].y1); return a }();
        var w = {
      ...
      function f(a) {
        for (var b, c = 0; c < C.length; c++)
          if (P[c].y1 < a && P[c].y4 > a) { b = P[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2), { x1: a, x2: a }) : -1
      }
        ...
        if (0 != t.length && (t.dataPoints &&
          ...
          if (-1 !== I) {
            ...
            return { source: Q, dest: this.plotArea.ctx, animationCallback: function(a, b) { M.fadeInAnimation(a, b);
                1 <= a && (h(z, -1, 500), v(z.plotArea.ctx || z.ctx)) }, easingFunction: M.easing.easeInQuad, animationBase: 0 }
          }
        }
      }
    };
    ...
    p.prototype.replaceKeywordsWithValue = function(a, d, b, c, e) {
      ...
      if ((0 <= b.type.indexOf("stacked") ||
        ...
        do {
          ...
          if (b.percentFormatString) h = b.percentFormatString;
              ...
              m = Math.max(Math.ceil(Math.log(1 / Math.abs(k)) / Math.LN10), 2); if (isNaN(m) || !isFinite(m)) m = 2; for (var s = 0; s < m; s++) h += "#";
            b.percentFormatString = h } a = a.replace("#percent", ba(k, h, g._cultureInfo));
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
        ...
        try { var f = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
          f && 0 < f.length && (k = Ia(f[2]), a = Ia(f[1])) } catch (l) {} f = null;
    ...
    z.prototype.createLabels = function() {
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
        ...
        if (this.labels) { a = Math.ceil(c); for (var c = Math.ceil(this.intervalStartPosition), f = !1, b = c; b < this.viewportMaximum; b += a)
            ...
            else { f = !1; break } f && (this.interval = a, this.intervalStartPosition = c) }
      ...
      for (c = 0; c < this._labels.length; c++) { a = this._labels[c].textBlock;
        a.maxWidth = g;
        a.maxHeight = k; var B = a.measureText();
        h = B.height } e = [];
      n = q = 0;
        ...
        if (u(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
          if (g = 0.9 * l >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
            ...
            for (b = 0; b < this._labels.length; b++)
              if (!this._labels[b].breaksLabelType) { a = this._labels[b].textBlock; for (var v, f = a.text.split(" "), c = 0; c < f.length; c++) p = f[c], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, p = this.ctx.measureText(p), p.width > n && (v = b, n = p.width) } b = 0;
              ...
              if (!this._labels[b].breaksLabelType) {
                ...
                for (f = b + 1; f < this._labels.length; f++)
                  if (!this._labels[f].breaksLabelType) { d = this._labels[f].textBlock;
                    d = d.measureText(); break } e.push(a.height);
      ...
      if ("undefined" ===
        ...
        if ("bottom" === this._position || "top" === this._position)
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            ...
            this._labels = b
          } else { for (m = 0; m < this._labels.length; m++) q = this._labels[m], q.position < this.viewportMinimum || (k = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += k);
            b > this.lineCoordinates.width * e && this.labelAutoFit && (d = !0) } if ("left" === this._position || "right" === this._position)
          if (this.logarithmic &&
            !this.equidistantInterval && this.labelAutoFit) { for (var b = [], p, l = this.viewportMaximum, h = this.lineCoordinates.height / Math.log(this.range), m = this._labels.length - 1; 0 <= m; m--) { q = this._labels[m]; if (q.position < this.viewportMinimum) break;
              q.position > this.viewportMaximum || !(m === this._labels.length - 1 || p < Math.log(l / q.position) * h) || (b.push(q), l = q.position, p = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle))) } this._labels = b } else {
            for (m =
    ...
    z.prototype.renderStripLinesOfThicknessType = function(a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (var d = this, b, c = 0, e = 0, g = !1, k = !1, l = [], h = [],
            k = !1, c = 0; c < this.stripLines.length; c++) { var m = this.stripLines[c];
      ...
      if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
        ...
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
          ...
          for (n = 0; n < p; n++) this.ctx.bezierCurveTo(h + g * a, m - a, h + g * a, m - 2 * a, h, m - 3 * a), m -= 3 * a, g *= -1
            ...
            m = e + a;
            h = c + a;
            p = (l - m) / a / 2; for (n = 0; n < p; n++) this.ctx.lineTo(h, m), h += 2 * g * a, m += 2 * a, g *= -1;
            this.ctx.lineTo(h, m);
            h += k - c; for (n = 0; n < p + 1; n++) this.ctx.lineTo(h, m), h += 2 * g * a, m -= 2 * a, g *= -1;
            this.ctx.lineTo(h + g * a, m + a) } } else if ("left" === this.scaleBreaks.parent._position || "right" ===
          ...
          if (e = 1 === q % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === q % 2 ? (c.y << 0) + 0.5 : c.y << 0, "left" === this.scaleBreaks.parent._position ? (c = this.chart.plotArea.x1, k = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2, k = this.chart.plotArea.x1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: c, y1: e - q / 2, x2: k, y2: l + q / 2 }, this.ctx.moveTo(c, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(k, e), this.ctx.lineTo(k, l),
            this.ctx.lineTo(c, l);
          else if ("wavy" === this.type) { h = c;
          m = e;
          g = 0.5;
          p = (k - h) / a / 3; for (n = 0; n < p; n++) this.ctx.bezierCurveTo(h + a, m + g * a, h + 2 * a, m + g * a, h + 3 * a, m), h += 3 * a, g *= -1;
          this.ctx.bezierCurveTo(h + a, m + g * a, h + 2 * a, m + g * a, h + 3 * a, m);
          m = l;
          g *= -1;
          this.ctx.lineTo(h, m); for (n = 0; n < p; n++) this.ctx.bezierCurveTo(h - a, m + g * a, h - 2 * a, m + g * a, h - 3 * a, m), h -= 3 * a, g *= -1 } else if ("zigzag" === this.type) {
          g = 1;
          m = e - a;
          h = c + a;
          p = (k - h) / a / 2;
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
          if ("xySwapped" ===
            ...
            var l = [];
            if (this.chart.axisX)
              for (var h = 0; h < this.chart.axisX.length; h++) { for (var k = this.chart.axisX[h].convertPixelToValue({ y: d }), m = null, c = 0; c < this.chart.axisX[h].dataSeries.length; c++)(m = this.chart.axisX[h].dataSeries[c].getDataPointAtX(k, b)) && 0 <= m.index && (m.dataSeries = this.chart.axisX[h].dataSeries[c], null !== m.dataPoint.y && l.push(m));
                m = null }
          ...
          if (m = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex = m.dataPointIndex, this.currentSeriesIndex = m.dataSeries.index;
            ...
            if (m = ab(a, d, this.chart._eventManager.ghostCtx), 0 < m && "undefined" !== typeof this.chart._eventManager.objectMap[m]) { m = this.chart._eventManager.objectMap[m]; if ("legendItem" === m.objectType) return;
              this.currentSeriesIndex = m.dataSeriesIndex;
              this.currentDataPointIndex = 0 <= m.dataPointIndex ? m.dataPointIndex : -1 } else this.currentDataPointIndex = -1;
    ...
    $.prototype.getToolTipInnerHTML = function(a) {
      ...
      for (var d = null, b = null,
        ...
        if (a[h].dataSeries.toolTipContent || a[h].dataPoint.toolTipContent) { k = !1; break } if (k && (this.content && "function" === typeof this.content || this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, d = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
    ...
    ha.prototype.mouseEventHandler = function(a) {
      if ("mousemove" === a.type || "click" === a.type) {
        ...
        for (b = 0; b < this.mouseoveredObjectMaps.length; b++) { g = !0; for (c = 0; c < d.length; c++)
            if (d[c].id === this.mouseoveredObjectMaps[b].id) { g = !1; break } g ? this.fireEvent(this.mouseoveredObjectMaps[b], "mouseout", a) : e.push(this.mouseoveredObjectMaps[b]) } this.mouseoveredObjectMaps = e;
        for (b = 0; b < d.length; b++) {
          e = !1;
          for (c = 0; c < this.mouseoveredObjectMaps.length; c++)
            if (d[b].id === this.mouseoveredObjectMaps[c].id) { e = !0; break } e || (this.fireEvent(d[b], "mouseover", a), this.mouseoveredObjectMaps.push(d[b]));
